...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 10:54 AM
...
(6, 10, 84, NULL, 'ok', NULL, 'pengemasan', '2021-04-29 09:07:28', '2021-04-29 09:07:28'),
(26, 3, 81, NULL, 'ok', NULL, 'pengemasan', '2021-04-30 03:35:02', '2021-04-30 03:38:25'),
(27, 3, 85, NULL, 'ok', NULL, 'pengemasan', '2021-04-30 03:36:39', '2021-04-30 03:38:25');
...
CREATE TABLE `histori_hasil_perakitans` (
  ...
  `keterangan` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tindak_lanjut` enum('ok','operator','produk_spesialis','perbaikan','karantina','ps','aging') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 5, 'Belum', NULL, 168, 85, NULL, NULL, NULL, NULL, NULL, 'Normal', 'Saliva', 'negatif', NULL, NULL, '2021-04-27 03:27:28', '2021-04-27 03:27:28'),
