...
(1, 11, '2021-05-18', 100, 120, 7, 'hbhn', '2021-05-18 07:42:45', '2021-05-18 07:42:45'),
...
(5, 9, '2021-05-18', 100, NULL, NULL, 'ads', '2021-05-18 07:43:48', '2021-05-18 07:43:48');
...
CREATE TABLE `hasil_monitoring_proses` (
  ...
  `keterangan` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tindak_lanjut` enum('pengemasan','perbaikan','produk_spesialis','karantina') COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('req_perbaikan','acc_perbaikan','rej_perbaikan','req_analisa_perbaikan','acc_analisa_perbaikan','rej_analisa_perbaikan','pengemasan') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(26, 3, 81, NULL, 'nok', NULL, 'produk_spesialis', 'acc_perbaikan', '2021-04-30 03:35:02', '2021-05-07 08:49:29'),
(29, 10, 84, NULL, 'nok', NULL, 'perbaikan', 'req_perbaikan', '2021-05-06 08:44:27', '2021-05-07 08:47:53'),
...
(10, 11, 85, NULL, 'baik', 'nok', NULL, 'perbaikan', 'req_pengujian', '2021-05-11 01:49:31', '2021-05-11 01:49:31'),
(11, 12, 83, NULL, 'baik', 'nok', NULL, 'perbaikan', 'req_pengujian', '2021-05-18 09:43:30', '2021-05-18 09:43:30');
...
CREATE TABLE `histori_hasil_perakitans` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `hasil_perakitan_id` bigint(20) UNSIGNED DEFAULT NULL,
  `kegiatan` enum('perbaikan_pemeriksaan_terbuka','pemeriksaan_terbuka','perbaikan_pemeriksaan_tertutup','pemeriksaan_tertutup','analisa_pemeriksaan_terbuka_ps','analisa_pemeriksaan_tertutup_ps','pemeriksaan_pengujian','perbaikan_pengujian','analisa_pengujian_ps') COLLATE utf8mb4_unicode_ci NOT NULL,
  `tanggal` date NOT NULL,
  `hasil` enum('ok','nok') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `keterangan` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tindak_lanjut` enum('ok','operator','produk_spesialis','perbaikan','karantina','ps','aging','pengemasan') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
