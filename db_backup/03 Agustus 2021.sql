...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 03, 2021 at 11:24 AM
...
(81, 8, 100, '2021-08-02', '2021-08-13', 'permintaan', 'rgb(0, 98, 204)', 1, '2021-07-15 06:01:05', '2021-07-15 06:05:46'),
(82, 9, 100, '2021-08-16', '2021-08-26', 'disetujui', 'rgb(0, 98, 204)', 2, '2021-07-15 06:01:48', '2021-07-15 06:05:19');
...
--
-- Table structure for table `kalibrasi_internals`
--

CREATE TABLE `kalibrasi_internals` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `kalibrasi_internals`
--

INSERT INTO `kalibrasi_internals` (`id`, `bppb_id`, `pic_id`, `tanggal_daftar`, `tanggal_permintaan_selesai`, `alias_barcode`, `no_pendaftaran`, `created_at`, `updated_at`) VALUES
(8, 32, 7, '2021-08-03', '2021-08-03', 'FX04/21/08/A', NULL, '2021-08-03 09:21:04', '2021-08-03 09:21:04');
...
--
-- Table structure for table `list_kalibrasi_internals`
--

CREATE TABLE `list_kalibrasi_internals` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `kalibrasi_internal_id` bigint(20) UNSIGNED NOT NULL,
  `hasil_perakitan_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `list_kalibrasi_internals`
--

INSERT INTO `list_kalibrasi_internals` (`id`, `kalibrasi_internal_id`, `hasil_perakitan_id`, `no_barcode`, `tanggal_kalibrasi`, `tanggal_selesai`, `hasil`, `tindak_lanjut`, `status`, `created_at`, `updated_at`) VALUES
(25, 8, 104, '00001', NULL, NULL, NULL, NULL, 'req_kalibrasi', '2021-08-03 09:21:04', '2021-08-03 09:21:04'),
(26, 8, 102, '00002', NULL, NULL, NULL, NULL, 'req_kalibrasi', '2021-08-03 09:21:04', '2021-08-03 09:21:04'),
(27, 8, 103, '00003', NULL, NULL, NULL, NULL, 'req_kalibrasi', '2021-08-03 09:21:04', '2021-08-03 09:21:04'),
(28, 8, 95, '00004', NULL, NULL, NULL, NULL, 'req_kalibrasi', '2021-08-03 09:21:04', '2021-08-03 09:21:04'),
(29, 8, 94, '00005', NULL, NULL, NULL, NULL, 'req_kalibrasi', '2021-08-03 09:21:04', '2021-08-03 09:21:04'),
(30, 8, 92, '00006', NULL, NULL, NULL, NULL, 'req_kalibrasi', '2021-08-03 09:21:04', '2021-08-03 09:21:04');
...
(3, 33, 11, '2021-07-13', 20, 'dibuat', '2021-07-13 06:05:24', '2021-07-13 06:05:24');
...
INSERT INTO `produks` (`id`, `kelompok_produk_id`, `kategori_id`, `ppic_id`, `merk`, `tipe`, `nama`, `kode_barcode`, `nama_coo`, `no_akd`, `kalibrasi`, `keterangan`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, 'elitech', 'SP-10', 'Digital Spirometer DS-PRO', 'SP01', 'SP-10', 'KEMENKES RI AKD 20401610237', 'tidak', NULL, 'hide', '2021-02-17 02:10:54', '2021-02-25 08:33:46'),
(2, 1, 1, NULL, 'elitech', 'DS-PRO100', 'Portable Spirometer', 'SP02', 'DS-PRO100', 'KEMENKES RI AKD 20401710665', 'tidak', NULL, NULL, '2021-02-17 02:17:06', '2021-02-17 02:17:06'),
(3, 1, 1, NULL, 'elitech', 'PROMIST-1', 'Mini Compressor Nebulizer', 'CN01', 'PROMIST-1', 'KEMENKES RI AKD 20403318003', 'tidak', NULL, NULL, '2021-02-17 00:33:42', '2021-02-17 00:33:42'),
(4, 1, 1, NULL, 'elitech', 'PROMIST-3', 'Medical Nebulizer', 'MN03', 'PROMIST-3', 'KEMENKES RI AKD 20403710661', 'tidak', NULL, NULL, '2021-02-17 00:43:49', '2021-02-17 00:43:49'),
(5, 1, 1, NULL, 'elitech', 'ULTRA MIST', 'Ultrasonic Nebulizer', 'UN01', 'ULTRA MIST', 'KEMENKES RI AKD 20403710663', 'tidak', NULL, NULL, '2021-02-17 00:49:18', '2021-02-17 00:49:18'),
(6, 1, 1, NULL, 'elitech', 'MOC-A', 'Oxygen Concentrator', 'OC01', 'MOC-A', 'KEMENKES RI AKD 20403510582', 'tidak', NULL, NULL, '2021-02-17 00:52:30', '2021-02-17 00:52:30'),
(7, 1, 2, 11, 'elitech', 'FOX-BABY', 'Pulse Oximeter', 'FX04', 'FOX-BABY', 'KEMENKES RI AKD 20502318005', 'ya', NULL, NULL, '2021-02-17 01:01:37', '2021-02-17 01:01:37'),
(8, 1, 2, NULL, 'elitech', 'FOX-3', 'Pulse Oximeter', 'FX06', 'FOX-3', 'KEMENKES RI AKD 20502210101', 'tidak', NULL, NULL, '2021-02-17 01:05:31', '2021-02-17 01:05:31'),
(9, 1, 2, NULL, 'elitech', 'PM50', 'SPO2 Monitor', 'PM07', 'PM50', '5656', 'tidak', 'we', NULL, '2021-02-17 01:08:00', '2021-04-05 23:24:52'),
(10, 1, 2, NULL, 'elitech', 'ABPM50', 'Ambulatory Blood Pressure Monitor', 'PM06', 'ABPM50', 'KEMENKES RI AKD 20501510581', 'tidak', NULL, NULL, '2021-02-17 01:12:41', '2021-02-17 01:12:41'),
(11, 1, 2, NULL, 'elitech', 'TENSIONE', 'Electrocardiograph', 'BP01', 'TENSIONE', 'KEMENKES RI AKD 20501318004', 'tidak', NULL, NULL, '2021-02-20 07:20:32', '2021-02-20 07:20:32'),
(12, 1, 2, NULL, 'elitech', 'ECG-300G', 'Electrocardiograph', 'EM02', 'ECG-300G', 'KEMENKES RI AKD 21102900255', 'tidak', NULL, NULL, '2021-02-20 07:22:28', '2021-02-20 07:22:28'),
(13, 1, 2, NULL, 'elitech', 'ECG-1200G', 'Electrocardiograph', 'EM03', 'ECG-1200G', 'KEMENKES RI AKD 20502310189', 'tidak', NULL, NULL, '2021-02-20 07:24:16', '2021-02-20 07:24:16'),
(14, 1, 2, NULL, 'elitech', 'PM-9000+', 'Patient Monitor', 'PM01', 'PM-9000+', 'KEMENKES RI AKD 20903900075', 'tidak', NULL, NULL, '2021-02-20 07:26:16', '2021-02-20 07:26:16'),
(15, 1, 4, NULL, 'elitech', 'TS-5830', 'Dental Unit', 'DU01', 'TS-5830', 'KEMENKES RI AKD 10605900071', 'tidak', NULL, NULL, '2021-02-20 07:29:55', '2021-02-20 07:29:55'),
(16, 1, 4, NULL, 'elitech', 'TS-8830', 'Dental Unit', 'DU02', 'TS-8830', 'KEMENKES RI AKD 10605810069', 'tidak', NULL, NULL, '2021-02-20 07:31:24', '2021-02-20 07:31:24'),
(17, 1, 4, NULL, 'elitech', 'TOP-308', 'Dental Unit', 'DU03', 'TOP-308', 'KEMENKES RI AKD 10605900070', 'tidak', NULL, NULL, '2021-02-20 07:32:48', '2021-02-20 07:32:48'),
(18, 1, 5, NULL, 'elitech', 'END-1 (1 Fungsi)', 'Medical Destroyer', 'ND03', 'END-1 (1 Fungsi)', 'KEMENKES RI AKD 20902210075', 'tidak', NULL, NULL, '2021-02-20 07:35:42', '2021-02-20 07:35:42'),
(19, 1, 6, NULL, 'elitech', 'BL-50B', 'Infant Phototherapy Unit', 'BL01', 'BL-50B', 'KEMENKES RI AKD 20903900073', 'tidak', NULL, NULL, '2021-02-20 07:38:01', '2021-02-20 07:38:01'),
(20, 1, 6, NULL, 'elitech', 'BN-100', 'Infant Warmer', 'BN01', 'BN-100', 'KEMENKES RI AKD 20903900074', 'tidak', NULL, NULL, '2021-02-20 07:40:39', '2021-02-20 07:40:39'),
(21, 1, 6, NULL, 'elitech', 'BB-200', 'Infant Incubator', 'BB01', 'BB-200', 'KEMENKES RI AKD 20903900076', 'tidak', NULL, NULL, '2021-02-20 07:42:39', '2021-02-20 07:42:39'),
(22, 1, 6, NULL, 'elitech', 'BT-100 (SMALL TROLLEY)', 'Infant Incubator Transport', 'BT01', 'BT-100 (SMALL TROLLEY)', 'KEMENKES RI AKD 20902710901', 'tidak', NULL, NULL, '2021-02-20 07:45:20', '2021-02-20 07:45:20'),
(23, 1, 7, NULL, 'elitech', 'MEL-02', 'Lampu Periksa LED', 'ML01', 'MEL-02', 'KEMENKES RI AKD 10903710660', 'tidak', NULL, NULL, '2021-02-20 07:47:22', '2021-02-20 07:47:22'),
(24, 1, 7, NULL, 'elitech', 'MOL-01', 'Lampu Operasi LED', 'OL01', 'MOL-01', 'KEMENKES RI AKD 21603710667', 'tidak', NULL, NULL, '2021-02-20 07:49:47', '2021-02-20 07:49:47'),
(25, 1, 7, NULL, 'elitech', 'MOL-02', 'Lampu Operasi LED', 'OL21', 'MOL-02', 'KEMENKES RI AKD 21603710788', 'tidak', NULL, NULL, '2021-02-20 07:51:07', '2021-02-20 07:51:07'),
(26, 1, 9, NULL, 'elitech', 'SONOTRAX-B', 'Pocket Fetal Doppler', 'FD02', 'SONOTRAX-B', 'KEMENKES RI AKD 21102800003', 'tidak', NULL, NULL, '2021-02-20 07:54:23', '2021-02-20 07:54:23'),
(27, 1, 9, NULL, 'elitech', 'SONOTRAX-C', 'Pocket Fetal Doppler', 'FD07', 'SONOTRAX-C', 'KEMENKES RI AKD 21101710077', 'tidak', NULL, NULL, '2021-02-20 07:55:47', '2021-02-20 07:55:47'),
(28, 1, 9, NULL, 'elitech', 'SONOTRAX PRO2', 'Ultrasonic Table Doppler', 'FD05', 'SONOTRAX PRO2', 'KEMENKES RI AKD 21101810461', 'tidak', NULL, NULL, '2021-02-20 07:58:46', '2021-02-20 07:58:46'),
(29, 1, 9, NULL, 'elitech', 'SONOTRAX MED-01', 'Fetal Monitor', 'SM01', 'SONOTRAX MED-01', 'KEMENKES RI AKD 21101710857', 'tidak', NULL, NULL, '2021-02-20 08:00:53', '2021-02-20 08:00:53'),
(30, 1, 9, NULL, 'elitech', 'MATERNAL MED-02', 'Fetal Monitor', 'SM02', 'MATERNAL MED-02', 'KEMENKES RI AKD 21101710864', 'tidak', NULL, NULL, '2021-02-20 08:02:31', '2021-02-20 08:02:31'),
(32, 1, 9, NULL, 'elitech', 'PRA-ONE', 'Digital USG Monitor', 'US01', 'PRA-ONE', 'KEMENKES RI AKD 21102410010', 'tidak', NULL, NULL, '2021-02-20 08:06:37', '2021-02-20 08:06:37'),
(33, 1, 9, NULL, 'elitech', 'PROMAX', '3D/4D Portable Color Doppler Ultrasound', 'US02', 'PROMAX', 'KEMENKES RI AKD 21102410011', 'tidak', NULL, NULL, '2021-02-20 08:08:08', '2021-02-20 08:08:08'),
(34, 1, 10, NULL, 'elitech', 'MFV-01', 'X-Ray Film Viewer', 'MV01', 'MFV-01', 'KEMENKES RI AKD 21501810001', 'tidak', NULL, NULL, '2021-02-20 08:10:24', '2021-02-20 08:10:24'),
(35, 1, 11, NULL, 'elitech', 'BABY ONE', 'Baby Scale', 'TD03', 'BABY ONE', 'KEMENKES RI AKD 10901318002', 'tidak', NULL, NULL, '2021-02-20 08:12:05', '2021-02-20 08:12:05'),
(36, 1, 11, NULL, 'elitech', 'BABY DIGIT-ONE', 'Timbangan Bayi Mekanik', 'TM01', 'BABY DIGIT-ONE', 'KEMENKES RI AKD 10901410295', 'tidak', NULL, NULL, '2021-02-20 08:13:55', '2021-02-20 08:13:55'),
(37, 1, 11, NULL, 'elitech', 'DIGIT-ONE BABY', 'Timbangan Bayi Digital', 'TD05', 'DIGIT-ONE BABY', 'KEMENKES RI AKD 10901410291', 'tidak', NULL, NULL, '2021-02-20 08:15:38', '2021-02-20 08:15:38'),
(38, 1, 11, NULL, 'elitech', 'DIGIT-PRO', 'Patient Scale', 'TD02', 'DIGIT-PRO', 'KEMENKES RI AKD 10901318001', 'tidak', NULL, NULL, '2021-02-20 08:18:05', '2021-02-20 08:18:05'),
(39, 1, 12, NULL, 'elitech', 'MED-S100', 'SPO2 Simulator', 'MS01', 'MED-S100', 'KEMENKES RI AKD 20401710856', 'tidak', NULL, NULL, '2021-02-20 08:19:27', '2021-02-20 08:19:27'),
(40, 1, 12, NULL, 'elitech', 'MED-S200', 'NIBP Simulator', 'MS02', 'MED-S200', 'KEMENKES RI AKD 20501710666', 'tidak', NULL, NULL, '2021-02-20 08:20:55', '2021-02-20 08:20:55'),
(41, 1, 12, NULL, 'elitech', 'MED-S400', 'Patient Simulator', 'MS04', 'MED-S400', 'KEMENKES RI AKD 20502710662', 'tidak', NULL, NULL, '2021-02-20 08:22:31', '2021-02-20 08:22:31'),
(42, 1, 13, NULL, 'elitech', 'GET 338 UO', 'Sterilisator Kering', 'LS07', 'GET 338 UO', 'KEMENKES RI AKD 20903800291', 'tidak', NULL, NULL, '2021-02-20 08:26:54', '2021-02-20 08:26:54'),
(43, 1, 13, NULL, 'elitech', 'GET-80C', 'Sterilisator Kering', 'LS04', 'GET-80C', 'KEMENKES RI AKD 20903800282', 'tidak', NULL, NULL, '2021-02-20 08:28:39', '2021-02-20 08:28:39'),
(44, 1, 13, NULL, 'elitech', 'GET-160', 'Sterilisator Kering', 'LS11', 'GET-160', 'KEMENKES RI AKD 20903800287', 'tidak', NULL, NULL, '2021-02-20 08:30:59', '2021-02-20 08:30:59'),
(45, 1, 13, NULL, 'elitech', 'ZTP80AS Upgrade', 'Medical Sterilizer', 'LS03', 'ZTP80AS Upgrade', 'KEMENKES RI AKD 20903700359', 'tidak', NULL, NULL, '2021-02-20 08:33:20', '2021-02-20 08:33:20'),
(46, 1, 13, NULL, 'elitech', 'ZTP-300', 'Sterilisator Kering', 'LS12', 'ZTP-300', 'KEMENKES RI AKD 20903800288', 'tidak', NULL, NULL, '2021-02-20 08:34:40', '2021-02-20 08:34:40'),
(47, 1, 14, NULL, 'elitech', 'ROLL PAPER FOR ECG-300G', 'Kertas ECG / Roll Paper', 'RL01', 'ROLL PAPER FOR ECG-300G', 'KEMENKES RI AKD 21102900255', 'tidak', NULL, NULL, '2021-02-20 08:37:37', '2021-02-20 08:37:37'),
(48, 1, 14, NULL, 'elitech', 'ROLL PAPER FOR ECG-1200G', 'Kertas ECG / Roll Paper', 'RL02', 'ROLL PAPER FOR ECG-1200G', 'KEMENKES RI AKD 20502310189', 'tidak', NULL, NULL, '2021-02-20 08:40:38', '2021-02-20 08:40:38'),
(49, 1, 1, NULL, 'elitech', 'DP1', 'Ultrasonic Pocket Doppler', 'FD06', 'DP1', 'KEMENKES RI AKD 21101810460', 'tidak', NULL, NULL, '2021-02-25 02:51:47', '2021-02-25 07:56:38'),
(50, 1, 1, NULL, 'elitech', 'PM PRO-2', 'Patient Monitor', 'PM09', 'PM PRO-2', 'KEMENKES RI AKD 20502810356', 'tidak', NULL, NULL, '2021-02-25 07:41:39', '2021-03-09 01:17:45'),
(51, 1, 14, NULL, 'elitech', 'USG PROMAX Trolley', 'Trolley for Medical Equipment', 'TR02', 'USG PROMAX Trolley', '-', 'tidak', NULL, NULL, '2021-02-25 08:10:13', '2021-03-09 07:41:57'),
(53, NULL, NULL, NULL, 'mentor', 'Pensil', 'RAEE', NULL, NULL, NULL, 'tidak', 'fsdfsdf', NULL, '2021-04-05 21:25:32', '2021-04-05 21:25:32'),
(54, NULL, NULL, NULL, 'vanward', 'Pensil 2B', 'Pensil 2B Kayu', NULL, NULL, NULL, 'tidak', NULL, NULL, '2021-04-05 21:29:43', '2021-04-05 21:29:43'),
(55, 1, 9, 11, 'elitech', 'CMS-600 PLUS', 'B-Ultrasound Diagnostic System', 'TR05', 'CMS-600 PLUS', 'KEMENKES RI AKD 21102900256', 'tidak', NULL, NULL, '2021-04-15 22:04:32', '2021-04-15 22:04:32'),
(56, 1, 5, 12, 'elitech', 'END-1', 'Needle Destroyer', 'TR05', 'END-1', 'KEMENKES RI AKD 21102900256', 'tidak', 'TEST', NULL, '2021-04-16 02:00:01', '2021-04-16 02:00:01');
...
--
-- Indexes for table `kalibrasi_internals`
--
ALTER TABLE `kalibrasi_internals`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `list_kalibrasi_internals`
--
ALTER TABLE `list_kalibrasi_internals`
  ADD PRIMARY KEY (`id`),
  ADD KEY `list_kalibrasi_internals_kalibrasi_internal_id_foreign` (`kalibrasi_internal_id`),
  ADD KEY `list_kalibrasi_internals_hasil_perakitan_id_foreign` (`hasil_perakitan_id`);
...
ALTER TABLE `packing_lists`
  ADD PRIMARY KEY (`id`),
  ADD KEY `packing_lists_supplier_id_foreign` (`supplier_id`);
...
--
-- AUTO_INCREMENT for table `kalibrasi_internals`
--
ALTER TABLE `kalibrasi_internals`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT for table `list_kalibrasi_internals`
--
ALTER TABLE `list_kalibrasi_internals`
...
--
-- Constraints for table `kalibrasi_internals`
--
ALTER TABLE `kalibrasi_internals`
...
--
-- Constraints for table `list_kalibrasi_internals`
--
ALTER TABLE `list_kalibrasi_internals`
  ADD CONSTRAINT `list_kalibrasi_internals_hasil_perakitan_id_foreign` FOREIGN KEY (`hasil_perakitan_id`) REFERENCES `hasil_perakitans` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `list_kalibrasi_internals_kalibrasi_internal_id_foreign` FOREIGN KEY (`kalibrasi_internal_id`) REFERENCES `kalibrasi_internals` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `packing_lists`
  ADD CONSTRAINT `packing_lists_supplier_id_foreign` FOREIGN KEY (`supplier_id`) REFERENCES `suppliers` (`id`) ON DELETE SET NULL;
