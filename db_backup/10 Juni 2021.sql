...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2021 at 11:53 AM
...
INSERT INTO `analisa_ps_perakitans` (`id`, `hasil_perakitan_id`, `analisa`, `realisasi_pengerjaan`, `tindak_lanjut`, `created_at`, `updated_at`) VALUES
(2, 91, 'Casing Patah', 'Mengganti Casing', 'operator', '2021-06-10 09:50:46', '2021-06-10 09:50:46');
...
(4, 9, NULL, NULL, 'ok', NULL, 'pengemasan', 'pengemasan', '2021-04-29 01:01:38', '2021-04-29 01:01:38'),
(26, 3, NULL, NULL, 'nok', NULL, 'perbaikan', 'acc_perbaikan', '2021-04-30 03:35:02', '2021-05-19 09:54:24'),
(29, 10, NULL, NULL, 'nok', 'Barang tidak berfungsi dengan baik', 'produk_spesialis', 'req_analisa_perbaikan', '2021-05-06 08:44:27', '2021-05-24 07:58:43'),
(30, 10, NULL, NULL, 'ok', NULL, 'pengemasan', 'pengemasan', '2021-05-06 08:44:27', '2021-05-06 08:44:27'),
(31, 13, NULL, NULL, NULL, 'pengujian pengemasan', NULL, NULL, '2021-05-19 09:40:44', '2021-05-19 09:40:44'),
(32, 13, NULL, NULL, NULL, 'pengujian pengemasan', NULL, NULL, '2021-05-19 09:40:44', '2021-05-19 09:40:44'),
(33, 14, NULL, NULL, NULL, 'pengujian pengemasan', NULL, NULL, '2021-05-25 02:08:51', '2021-05-25 02:08:51'),
(34, 10, NULL, NULL, 'ok', NULL, 'pengemasan', 'pengemasan', '2021-05-27 03:57:25', '2021-05-27 03:57:25'),
(35, 15, NULL, NULL, NULL, 'pengujian pengemasan', NULL, NULL, '2021-05-27 09:44:52', '2021-05-27 09:44:52');
...
(10, 11, NULL, NULL, 'baik', 'nok', NULL, 'perbaikan', 'acc_perbaikan', '2021-05-11 01:49:31', '2021-05-19 09:40:44'),
(11, 12, NULL, NULL, 'baik', 'nok', NULL, 'perbaikan', 'acc_perbaikan', '2021-05-18 09:43:30', '2021-05-19 09:40:44'),
(12, 13, NULL, NULL, 'baik', 'nok', 'Ucaaaakk', 'perbaikan', 'acc_perbaikan', '2021-05-27 04:05:26', '2021-05-27 09:44:52');
...
(91, 41, '2021-06-09', '00001', 'ok', 'ok', 'nok', 'produk_spesialis', 'tes', NULL, NULL, NULL, NULL, NULL, NULL, 'analisa_pemeriksaan_terbuka_ps', '2021-06-09 09:07:15', '2021-06-10 09:50:46'),
(92, 41, '2021-06-09', '00002', 'ok', 'ok', 'ok', 'ok', NULL, 'ok', 'ok', 'nok', 'perbaikan', 'tes', NULL, 'rej_pemeriksaan_tertutup', '2021-06-09 09:07:15', '2021-06-10 01:40:09'),
(93, 41, '2021-06-09', '00003', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'req_pemeriksaan_terbuka', '2021-06-10 01:32:06', '2021-06-10 01:32:06'),
(94, 41, '2021-06-09', '00004', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'req_pemeriksaan_terbuka', '2021-06-10 01:32:06', '2021-06-10 01:32:06'),
(95, 41, '2021-06-09', '00005', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'req_pemeriksaan_terbuka', '2021-06-10 01:32:06', '2021-06-10 01:32:06'),
...
(98, 42, '2021-06-10', '00001', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'req_pemeriksaan_terbuka', '2021-06-10 07:01:12', '2021-06-10 07:01:12');
...
(24, 16, 'Adi Putra Firmantika', NULL, NULL, 'manager', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(44, 7, '2021-06-21', 160, 100, 'aa', '2021-06-04 09:16:48', '2021-06-08 08:51:09'),
...
--
-- Indexes for table `analisa_ps_pengemasans`
--
ALTER TABLE `analisa_ps_pengemasans`
  ADD PRIMARY KEY (`id`),
  ADD KEY `analisa_ps_pengemasans_hasil_perakitan_id_foreign` (`hasil_perakitan_id`);

--
-- Indexes for table `analisa_ps_pengemasan_parts`
--
ALTER TABLE `analisa_ps_pengemasan_parts`
  ADD KEY `analisa_ps_pengemasan_parts_bill_of_material_id_foreign` (`bill_of_material_id`),
  ADD KEY `analisa_ps_pengemasan_parts_analisa_ps_pengemasan_id_foreign` (`analisa_ps_pengemasan_id`);
...
--
-- AUTO_INCREMENT for table `analisa_ps_pengemasans`
--
ALTER TABLE `analisa_ps_pengemasans`
...
--
-- Constraints for table `analisa_ps_pengemasans`
--
ALTER TABLE `analisa_ps_pengemasans`
  ADD CONSTRAINT `analisa_ps_pengemasans_hasil_perakitan_id_foreign` FOREIGN KEY (`hasil_perakitan_id`) REFERENCES `hasil_perakitans` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `analisa_ps_pengemasan_parts`
--
ALTER TABLE `analisa_ps_pengemasan_parts`
  ADD CONSTRAINT `analisa_ps_pengemasan_parts_analisa_ps_pengemasan_id_foreign` FOREIGN KEY (`analisa_ps_pengemasan_id`) REFERENCES `analisa_ps_pengemasans` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `analisa_ps_pengemasan_parts_bill_of_material_id_foreign` FOREIGN KEY (`bill_of_material_id`) REFERENCES `bill_of_materials` (`id`) ON DELETE SET NULL;
