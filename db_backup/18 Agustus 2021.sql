...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2021 at 11:25 AM
...
--
-- Table structure for table `detail_kartu_stock_gbjs`
--

CREATE TABLE `detail_kartu_stock_gbjs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `kartu_stock_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `detail_kartu_stock_gbjs`
--

INSERT INTO `detail_kartu_stock_gbjs` (`id`, `kartu_stock_id`, `tanggal`, `keterangan`, `jumlah_masuk`, `jumlah_keluar`, `jumlah_saldo`, `created_at`, `updated_at`) VALUES
(1, 1, '2021-08-16', 'dari Produksi', 5.00, 0.00, 5.00, NULL, NULL),
(2, 1, '2021-08-18', 'dari Produksi', 5.00, 0.00, 10.00, NULL, NULL);
...
--
-- Table structure for table `kartu_stock_gbjs`
--

CREATE TABLE `kartu_stock_gbjs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `detail_produk_id` bigint(20) UNSIGNED NOT NULL,
  `nomor` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `kartu_stock_gbjs`
--

INSERT INTO `kartu_stock_gbjs` (`id`, `detail_produk_id`, `nomor`, `created_at`, `updated_at`) VALUES
(1, 8, 'GBJ-01/0005', NULL, NULL);
...
(16, 'CETIRIZINE HYDROCHLORIDE', 5, 'Cetirizine 10 mg\r\n(Alergi)', '2021-08-10 05:46:21', '2021-08-18 08:06:55'),
(17, 'PANADOL EXTRA', 3, 'Paracetamol 500mg\r\nCaffeine 65mg\r\n(Pereda Nyeri)', '2021-08-10 05:47:09', '2021-08-18 08:09:05'),
(18, 'OMEPRAZOLE', 2, 'Omeprazole 20mg\r\n(Meredakan Penyakit Asam Lambung)', '2021-08-10 05:48:29', '2021-08-10 05:48:29'),
(19, 'BUFACARYL', 3, 'Dexamethasone 0.5mg\r\nDexchlorpheniramine maleate 2mg\r\n(Alergi)', '2021-08-10 05:49:19', '2021-08-18 08:07:29'),
(20, 'PROMAG', 11, 'Hydrotalcite\r\nMg Hydroxide\r\nSimethicone\r\n(Meredakan Nyeri Lambung)', '2021-08-10 05:50:30', '2021-08-18 08:14:20'),
...
(31, 'FENAMIN', 12, 'Mefenamic Acid 500mg\r\n(Pereda Nyeri)', '2021-08-10 06:02:24', '2021-08-18 08:17:02'),
...
--
-- Indexes for table `detail_kartu_stock_gbjs`
--
ALTER TABLE `detail_kartu_stock_gbjs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `detail_kartu_stock_gbjs_kartu_stock_id_foreign` (`kartu_stock_id`);
...
--
-- Indexes for table `kartu_stock_gbjs`
--
ALTER TABLE `kartu_stock_gbjs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kartu_stock_gbjs_detail_produk_id_foreign` (`detail_produk_id`);
...
--
-- AUTO_INCREMENT for table `detail_kartu_stock_gbjs`
--
ALTER TABLE `detail_kartu_stock_gbjs`
...
--
-- AUTO_INCREMENT for table `kartu_stock_gbjs`
--
ALTER TABLE `kartu_stock_gbjs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `detail_kartu_stock_gbjs`
--
ALTER TABLE `detail_kartu_stock_gbjs`
  ADD CONSTRAINT `detail_kartu_stock_gbjs_kartu_stock_id_foreign` FOREIGN KEY (`kartu_stock_id`) REFERENCES `kartu_stock_gbjs` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `kartu_stock_gbjs`
--
ALTER TABLE `kartu_stock_gbjs`
  ADD CONSTRAINT `kartu_stock_gbjs_detail_produk_id_foreign` FOREIGN KEY (`detail_produk_id`) REFERENCES `detail_produks` (`id`) ON DELETE CASCADE;
