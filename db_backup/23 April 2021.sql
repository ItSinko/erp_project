...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2021 at 10:57 AM
...
CREATE TABLE `hasil_perakitans` (
  ...
  `tindak_lanjut_terbuka` enum('ok','operator','perbaikan','karantina','ps') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tindak_lanjut_tertutup` enum('ok','operator','perbaikan','karantina','ps','aging') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `hasil_perakitans` (`id`, `perakitan_id`, `tanggal`, `no_seri`, `kondisi_fisik_bahan_baku`, `kondisi_saat_proses_perakitan`, `tindak_lanjut_terbuka`, `keterangan_tindak_lanjut_terbuka`, `fungsi`, `kondisi_setelah_proses`, `hasil`, `tindak_lanjut_tertutup`, `keterangan_tindak_lanjut_tertutup`, `keterangan`, `status`, `created_at`, `updated_at`) VALUES
(76, 33, '2021-04-19', 'RMIN0001', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'req_pemeriksaan_terbuka', '2021-04-18 18:15:31', '2021-04-18 18:15:31'),
(77, 34, '2021-04-19', 'FRIN00001', 'ok', 'ok', 'operator', 'Kabel lapes', NULL, NULL, NULL, NULL, NULL, NULL, 'rej_pemeriksaan_terbuka', '2021-04-18 19:22:09', '2021-04-23 06:34:55'),
(78, 34, '2021-04-19', 'FRIN00002', 'ok', 'ok', 'ok', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'acc_pemeriksaan_terbuka', '2021-04-18 19:22:09', '2021-04-23 08:48:01'),
(80, 35, '2021-04-19', 'FRIN00004', 'nok', 'nok', 'operator', 'TES', NULL, NULL, NULL, NULL, NULL, NULL, 'rej_pemeriksaan_terbuka', '2021-04-18 19:40:33', '2021-04-23 08:53:48'),
(81, 35, '2021-04-19', 'FRIN00005', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'req_pemeriksaan_terbuka', '2021-04-18 19:40:33', '2021-04-20 21:01:41');
...
CREATE TABLE `histori_hasil_perakitans` (
  ...
  `hasil` enum('ok','nok') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `keterangan` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tindak_lanjut` enum('ok','operator','perbaikan','karantina','ps','aging') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
