...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2021 at 11:44 AM
...
(1, 4, 85, '2021-06-02 03:47:13', '2021-06-02 03:47:13'),
(2, 4, 83, '2021-06-02 03:47:13', '2021-06-02 03:47:13'),
(3, 4, 87, '2021-06-02 03:47:13', '2021-06-02 03:47:13');
...
CREATE TABLE `detail_permintaan_bahan_bakus` (
  `permintaan_bahan_baku` bigint(20) UNSIGNED DEFAULT NULL,
  `part_eng_id` bigint(20) UNSIGNED DEFAULT NULL,
...
(38, 19, 'Bagong', NULL, 'staff', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(22, '2021-05-31', 8, 17, 'Ana', 'Diag', 'Pengobatan', NULL, 1, 'Sebelum Makan', '1x1', 'Lanjut bekerja', '2021-05-31 02:19:56', '2021-05-31 02:19:56'),
(23, '2021-05-31', 8, 17, 'MUal Mual', 'Gak tahu', 'Pengobatan', NULL, 3, 'Sebelum Makan', '1x1', 'Lanjut bekerja', '2021-05-31 07:26:19', '2021-05-31 07:26:19'),
(24, '2021-06-23', 2, 17, 'Analisa', 'Diagnosa', 'Pengobatan', NULL, 3, 'Sesudah Makan', '1x1', 'Lanjut bekerja', '2021-06-02 01:34:10', '2021-06-02 01:34:10');
...
(1, 'Antangin', 4, NULL, NULL, '2021-05-31 02:19:56'),
(2, 'Promag 5g', 3, NULL, NULL, NULL),
(3, 'Decolgen Flu', 7, NULL, NULL, '2021-06-02 01:34:10'),
(4, 'Panadol Sakit Kepala', 3, NULL, NULL, NULL),
...
(11, 29, 2, 1, '2021-05-11', 'dibuat', '2021-05-11 01:49:31', '2021-05-11 01:49:31'),
(12, 29, 2, 1, '2021-05-18', 'dibuat', '2021-05-18 09:43:30', '2021-05-18 09:43:30'),
(13, 29, 2, 3, '2021-05-27', 'dibuat', '2021-05-27 04:05:26', '2021-05-27 04:05:26');
...
INSERT INTO `penyerahan_barang_jadis` (`id`, `bppb_id`, `divisi_id`, `tanggal`, `jumlah`, `status`, `created_at`, `updated_at`) VALUES
(4, 29, 12, '2021-06-02', 3, 'dibuat', '2021-06-02 03:47:13', '2021-06-02 03:47:13');
...
(10, 28, 'Hana', 'hana', 'hana@gmail.com', '$2y$10$EhyPPPA/HT9foUwbRXKraeGmA51hns1i7VUfCKZIbkV6p62C9lS4K', NULL, 'online', NULL, '2021-05-10 07:11:40', '2021-05-10 07:11:40'),
...
ALTER TABLE `detail_permintaan_bahan_bakus`
  ADD KEY `detail_permintaan_bahan_bakus_permintaan_bahan_baku_foreign` (`permintaan_bahan_baku`),
  ADD KEY `detail_permintaan_bahan_bakus_part_eng_id_foreign` (`part_eng_id`);
...
ALTER TABLE `perbaikan_produksi_parts`
  ...
  ADD KEY `perbaikan_produksi_parts_part_id_foreign` (`part_id`);
...
--
ALTER TABLE `detail_permintaan_bahan_bakus`
  ADD CONSTRAINT `detail_permintaan_bahan_bakus_part_eng_id_foreign` FOREIGN KEY (`part_eng_id`) REFERENCES `part_engs` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `detail_permintaan_bahan_bakus_permintaan_bahan_baku_foreign` FOREIGN KEY (`permintaan_bahan_baku`) REFERENCES `permintaan_bahan_bakus` (`id`) ON DELETE SET NULL;
...
--
ALTER TABLE `perbaikan_produksi_parts`
  ADD CONSTRAINT `perbaikan_produksi_parts_part_id_foreign` FOREIGN KEY (`part_id`) REFERENCES `part_engs` (`id`) ON DELETE CASCADE,
