...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2021 at 10:52 AM
...
CREATE TABLE `detail_produks` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `produk_id` bigint(20) UNSIGNED DEFAULT NULL,
  `nama_detail` varchar(225) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(31, 1, 9, 'elitech', 'CMS-600 PLUS', 'B-Ultrasound Diagnostic System', 'TR05', 'CMS-600 PLUS', 'KEMENKES RI AKD 21102900256', NULL, NULL, '2021-02-20 08:04:06', '2021-02-20 08:04:06'),
