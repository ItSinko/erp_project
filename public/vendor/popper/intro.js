...
(function (global, factory) {
        ...
        function DOMEvent() {
            ...
            this._id = function (obj, type, listener, context) {
                return (
                    type +
                    stamp(listener) +
                    (context ? "_".concat(stamp(context)) : "")
                );
            };
            /**
             * Adds event listener
    ...
    if (nativeWeakMap) {
        var store$1 =
            sharedStore.state || (sharedStore.state = new WeakMap$1());
    ...
    */
        ...
        function (SPLIT, nativeSplit, maybeCallNative) {
            ...
            return [
                ...
                function (regexp, limit) {
                    ...
                    if (lim === 0) return [];
                    if (S.length === 0)
                        return regexpExecAbstract(splitter, S) === null
                            ? [S]
                            : [];
                    var p = 0;
                    var q = 0;
                    ...
                    while (q < S.length) {
                        ...
                        if (
                            ...
                            (e = min$2(
                                toLength(
                                    splitter.lastIndex + (SUPPORTS_Y ? 0 : q)
                                ),
                                S.length
                            )) === p
                        ) {
            ...
            return [
                ...
                function (regexp, replaceValue) {
                    ...
                    for (var i = 0; i < results.length; i++) {
                        ...
                        var position = max$1(
                            min$3(toInteger(result.index), S.length),
                            0
                        );
                        var captures = [];
    ...
    function placeTooltip(targetElement, tooltipLayer, arrowLayer, hintMode) {
        ...
        switch (currentTooltipPosition) {
            ...
            case "right":
                tooltipLayer.style.left = "".concat(
                    targetOffset.width + 20,
                    "px"
                );

                if (
                    targetOffset.top + tooltipOffset.height >
                    windowSize.height
                ) {
    ...
    function _showElement(targetElement) {
        ...
        if (oldHelperLayer !== null) {
            ...
            var oldArrowLayer = oldReferenceLayer.querySelector(
                ".introjs-arrow"
            );
            ...
            self._lastShowElementTimer = window.setTimeout(function () {
                ...
                ).style.cssText = "width:".concat(
                    _getProgress.call(self),
                    "%;"
                );
                oldReferenceLayer
    ...
    function alignHintPosition(position, _ref, element) {
        ...
        switch (position) {
            ...
            case "top-right":
                style.left = "".concat(
                    offset.left + offset.width - iconWidth,
                    "px"
                );
                style.top = "".concat(offset.top, "px");
                break;
            ...
            case "bottom-left":
                style.left = "".concat(offset.left, "px");
                style.top = "".concat(
                    offset.top + offset.height - iconHeight,
                    "px"
                );
                break;
    ...
    function populateHints(targetElm) {
        ...
        if (this._options.hints) {
            ...
            forEach(hints, function (currentElement) {
                // hint animation
                var hintAnimation = currentElement.getAttribute(
                    "data-hintanimation"
                );
                ...
                _this5._introItems.push({
                    ...
                    tooltipClass: currentElement.getAttribute(
                        "data-tooltipclass"
                    ),
                    position:
    ...
    function refresh() {
        ...
        if (this._currentStep !== undefined && this._currentStep !== null) {
            ...
            var oldtooltipContainer = document.querySelector(
                ".introjs-tooltip"
            );
            placeTooltip.call(
                this,
        ...
        if (this._options.steps) {
            ...
            forEach(this._options.steps, function (step) {
                ...
                currentItem.scrollTo =
                    currentItem.scrollTo || _this._options.scrollTo;

                if (typeof currentItem.disableInteraction === "undefined") {
                    currentItem.disableInteraction =
                        _this._options.disableInteraction;
                }
            ...
            forEach(allIntroSteps, function (currentElement) {
                ...
                var step = parseInt(
                    currentElement.getAttribute("data-step"),
                    10
                );
            ...
            forEach(allIntroSteps, function (currentElement) {
                ...
                if (currentElement.getAttribute("data-step") === null) {
                    ...
                    if (
                        currentElement.hasAttribute("data-disable-interaction")
                    ) {
                        disableInteraction = !!currentElement.getAttribute(
                            "data-disable-interaction"
                        );
