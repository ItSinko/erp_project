...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function L(l, u, i) {
        ...
        if (
            ...
            (t = l.ref) &&
                ((t.current && t.current !== l.__e) || I(t, null, u)),
    ...
    */
    ...
    function getDayClassNames(meta, theme) {
        ...
        if (DAY_IDS[meta.dow] == "sun" || DAY_IDS[meta.dow] == "sat") {
            classNames.push("day-off");
        }
    ...
    */
    ...
    var ContentHookInner = /** @class */ (function (_super) {
        ...
        ContentHookInner.prototype.renderInnerContent = function () {
            var contentTypeHandlers = this.context.pluginHooks
                .contentTypeHandlers;
            var _a = this,
                props = _a.props,
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        DateProfileGenerator.prototype.buildCurrentRangeInfo = function (
            ...
            if (props.duration) {
                ...
                unit = props.dateEnv.greatestWholeUnit(range.start, range.end)
                    .unit;
            } else {
    ...
    */
    ...
    var CalendarDataManager = /** @class */ (function () {
        function CalendarDataManager(props) {
            ...
            var dateProfile = currentViewData.dateProfileGenerator.build(
                currentDate
            );
            ...
            var initialState = {
                ...
                eventDrag: null,
                eventResize: null,
                selectionConfig: this.buildViewUiProps(calendarContext)
                    .selectionConfig,
            };
        ...
        CalendarDataManager.prototype._handleAction = function (action) {
            ...
            if (
                ...
                // hack
                dateProfile = currentViewData.dateProfileGenerator.build(
                    currentDate
                );
            }
            ...
            for (var id in droppableStore) {
                ...
                if (
                    ...
                    if (
                        ...
                        var dateProfile = component.context.getCurrentData()
                            .dateProfile;
                        if (
                            hit &&
                ...
                if (_this.isDragging) {
                    ...
                    if (validMutation) {
                        ...
                        if (receivingContext_1 === initialContext_1) {
                            ...
                            for (
                                var _i = 0,
                                    _b = initialContext_1.getCurrentData()
                            ...
                            receivingContext_1.emitter.trigger(
                                ...
                                __assign(
                                    ...
                                    ),
                                    {
                                        ...
                                        jsEvent: ev.origEvent,
                                        view:
                                            finalHit.component.context.viewApi,
                                    }
                                )
                            );
                            receivingContext_1.emitter.trigger(
            ...
            this.handleHitUpdate = function (hit, isFinal, ev) {
                ...
                if (hit) {
                    ...
                    if (
                        ...
                        interaction.mutatedEvents = eventTupleToStore(
                            droppableEvent
                        );
            ...
            _this.handleMoreLinkClick = function (ev) {
                ...
                if (props.onMoreClick) {
                    ...
                    var hiddenSegs = allSegs.filter(function (seg) {
                        return props
                            .segIsHidden[seg.eventRange.instance.instanceId];
                    });
                    props.onMoreClick({
                        date: props.date,
                        allSegs: allSegs,
                    ...
                    return createElement(
                        ...
                        createElement(
                            "div",
                            {
                                ...
                                ref:
                                    props.innerElRef /* different from hook system! RENAME */,
                            },
                                    ...
                                    createElement(
                                        ...
                                        createElement(
                                            RenderHook,
                                            {
                                                hookProps: hookProps,
                                                classNames:
                                                    options.moreLinkClassNames,
                                                content:
                                                    options.moreLinkContent,
                                                defaultContent: renderMoreLinkInner,
                                                didMount:
                                                    options.moreLinkDidMount,
                                                willUnmount:
            ...
            for (
                ...
                if (!segIsHidden[seg.eventRange.instance.instanceId]) {
                    ...
                    if (
                        ...
                        currentAbsHeight =
                            placement.bottom - currentNonAbsBottom;
                    }
                }
            }
            if (currentAbsHeight) {
    ...
    */
                ...
                props.cells.map(function (cell, col) {
                    ...
                    return createElement(TableCell, {
                        ...
                        onMoreClick: function (arg) {
                            props.onMoreClick(
                                __assign(__assign({}, arg), { fromCol: col })
                            );
                        },
                        segIsHidden: segIsHidden,
    ...
    var Popover = /** @class */ (function (_super) {
        ...
        function Popover() {
            var _this =
                (_super !== null && _super.apply(this, arguments)) || this;
            _this.repositioner = new DelayedRunner(
                _this.updateSize.bind(_this)
            );
            _this.handleRootEl = function (el) {
                _this.rootEl = el;
                if (_this.props.elRef) {
        ...
        Popover.prototype.render = function () {
            ...
            return createElement(
                ...
                createElement(
                    ...
                    createElement("span", {
                        className:
                            "fc-popover-close " + theme.getIconClass("close"),
                ...
                createElement(
                    ...
                    function (nowDate, todayRange) {
                        return createElement(
                                ...
                                createElement(
                                    ...
                                    props.cells.map(function (cells, row) {
                                        return createElement(TableRow, {
                                            ...
                                            eventSelection:
                                                props.eventSelection,
                                            bgEventSegs: bgEventSegsByRow[
                                                row
                                            ].filter(isSegAllDay) /* hack */,
                            ...
                            !props.forPrint &&
                                morePopoverState &&
                                morePopoverState.currentFgEventSegs ===
                                    props.fgEventSegs &&
                                createElement(MorePopover, {
                                    ...
                                    topAlignmentEl:
                                        rowCnt === 1
                                            ? props.headerAlignElRef.current
                                            : null,
    ...
    */
    ...
    var TimeCol = /** @class */ (function (_super) {
            ...
            return segs.map(function (seg) {
                ...
                var positionCss = isMirror
                    ? // will span entire column width
                      ...
                      __assign(
                          { left: 0, right: 0 },
                          _this.computeSegTopBottomCss(seg)
                      )
                ...
                return createElement(
                    "div",
                    {
                        ...
                        style: __assign(
                            {
                                visibility: segIsInvisible[instanceId]
                                    ? "hidden"
                                    : "",
                            },
                            positionCss
                        ...
                        __assign(
                            {
                                ...
                                isCondensed:
                                    seg.bottom - seg.top <
                                    config.timeGridEventCondensedHeight,
                            },
                            getSegMeta(seg, props.todayRange, props.nowDate)
                        )
                    )
        ...
        TimeCol.prototype.computeFgSegPositionCss = function (seg) {
            ...
            return __assign(
                __assign({}, props),
                this.computeSegTopBottomCss(seg)
            );
        };
    ...
    var TimeCols = /** @class */ (function (_super) {
        ...
        TimeCols.prototype.positionToHit = function (
            positionLeft,
            positionTop
        ) {
            var _a = this.context,
