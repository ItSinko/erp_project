        ...
        <div class="col-md-8">
            <div class="box box-default">
                <div class="box-header no-border text-center">
                    <h3 class="box-title">Unggah Cepat</h3>
                ...
                <div class="box-body">
                    <form action="#" class="text-center" style="width: 30vw;margin: 0 auto;" onsubmit="return gotoUpload()">
                        <div class="form-group">
                            <label for="">Pilih {{ucfirst(config('settings.document_label_singular'))}}</label>
            ...
            <div class="info-box bg-green">
                ...
                <div class="info-box-content">
                    ...
                    <span class="progress-description">
                        Berisi {{$filesCounts}} {{ucfirst(config('settings.file_label_plural'))}}
                    </span>
                </div>
                <!-- /.info-box-content -->
            </div>
                ...
                <div class="box-header no-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <button type="button" id="activityrange" class="btn btn-default btn-sm">
                            ...
                            <span>Pilih tanggal</span> <i class="fa fa-caret-down"></i>
                        </button>
