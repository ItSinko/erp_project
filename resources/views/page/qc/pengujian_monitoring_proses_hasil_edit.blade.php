            ...
            <div class="col-md-9">
                ...
                <div class="card">
                    <div class="card-header bg-warning">
                        <h3 class="card-title"><i class="fas fa-pencil-alt" aria-hidden="true"></i>&nbsp;Tambahkan Hasil Monitoring Proses</h3>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control  @error('no_seri') is-invalid @enderror " name="no_seri" id="no_seri" value="{{old('no_seri', $s->HasilPerakitan->no_seri)}}" style="width: 40%;" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control  @error('no_barcode') is-invalid @enderror barcode" name="no_barcode" id="no_barcode" value="{{old('no_barcode', $s->no_barcode)}}" style="width: 40%;">
                                            </div>
                                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <span>
                            <button type="submit" class="btn btn-block btn-warning rounded-pill" style="width:200px;float:right;"><i class="fas fa-edit"></i>&nbsp;Simpan Data</button>
                        </span>
                    </div>
                    </form>
                </div>
