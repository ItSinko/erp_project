...
<section class="content">
    <div class="row">
        ...
        <div class="col-9">
            ...
            @endif
            <form action="{{route('pengujian.format_lkp_lup.store', ['id' => $b->id])}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-horizontal">
                            <div class="form-group row">
                                <label for="nama_pengecekan" class="col-sm-5 col-form-label" style="text-align:right;">Pengecekan</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control @error('nama_pengecekan') is-invalid @enderror" name="nama_pengecekan" id="nama_pengecekan" value="" style="width: 50%;">
                                </div>
