                    ...
                    <table class="table mdtxt" style="width:100%;" border=1 style="border-collapse: collapse;">
                        <tbody>
                            <tr>
                                ...
                                <td class="vera">Diuji Oleh</td>
                                <td class="vera">Disetujui Oleh</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <table class="table mdtxt" width=100%>
                    <tbody class="vera">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>Pengujian Timbangan Mekanik</td>
                        </tr>
                        <tr>
        ...
        <div class="row mdtxt">
            ...
            <table class="table" border="1" style="border-collapse: collapse; text-align:center;" width="80%">
                ...
                <tbody class="nospace">
                    ...
                    <tr>
                        <td>2</td>
                        <td>Timbangan Digital(Master)</td>
                        <td>Elitech</td>
                        <td>-</td>
                        <td>-</td>
                    </tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="57%" class="vera">
                                    <table>
                                    <tr>
                                        <td rowspan="3" class="nospace vera">D.</td>
                                        <td colspan="2">Kegiatan Pengujian(mengacu kepada Metode Kerja)</div></td>
                                    </tr>
                                    <tr>
                                        <td rowspan="2" class="nospace vera">a.</td>
                                        <td>Pemeriksaan Kondisi Fisik dan Fungsi Komponen Alat</td>
                                    </tr>
                                    <tr>
                                        <td>
                                        <table border="1" style="border-collapse: collapse;text-align:center;" width="100%">
...
<div class="card">
    <div class="card-body">
        <table width="100%" class="mdtxt">
            <tbody>
                <tr>
                    <td rowspan="3" class="nospace vera">b.</td>
                    <td>Pengaturan kinerja (Kuantitatif)</td>
                </tr>
                <tr>    
                    <td>1. Berat (kg) Anak Timbangan</td>
                </tr>
                <tr>
                    <td>
                        <table border="1" style="border-collapse: collapse;text-align:center;" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="2" class="wb">Anak Timbangan</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td class="nospace">5 kg</td>
                                    <td class="nospace">5</td>
                                    <td class="nospace">5</td>
                                    <td class="nospace">5</td>
                                    <td class="nospace">5</td>
                                    <td class="nospace">5</td>
                                    <td class="nospace">5</td>
                                    <td class="nospace">5</td>
                                    <td class="nospace">OK</td>
                                    <td class="nospace" rowspan="4">0.2 Kg</td>
                                </tr>
                                <tr>
                                    <td class="nospace">2</td>
                                    <td class="nospace">10 kg</td>
                                    <td class="nospace">10</td>
                                    <td class="nospace">10</td>
                                    <td class="nospace">10</td>
                                    <td class="nospace">10</td>
                                    <td class="nospace">10</td>
                                ...
                                <tr>
                                    <td class="nospace">3</td>
                                    <td class="nospace">15 kg</td>
                                    <td class="nospace">15</td>
                                    <td class="nospace">15</td>
                                    <td class="nospace">15</td>
                                    <td class="nospace">15</td>
                                    <td class="nospace">15</td>
                                ...
                                <tr>
                                    <td class="nospace">4</td>
                                    <td class="nospace">25 kg</td>
                                    <td class="nospace">24,8</td>
                                    <td class="nospace">24,8</td>
                                    <td class="nospace">24,8</td>
                                    <td class="nospace">24,8</td>
                                    <td class="nospace">24,8</td>
        ...
        <div class="row">
            <table border=0 class="table mdtxt" width="100%">
                <tbody>
                    <tr>
                        <td width="47%">
                            <div>E. Telaah Teknis Pengujian</div>
                            <table width="100%" border="1" style="border-collapse: collapse;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="nospace" style="text-align:center;"><b>OK</b></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                        ...
                        <td width="47%" class="vera">
                            <div>F. Kesimpulan Telaah Teknis Pengujian</div>
                            <table width="100%" border="1" style="border-collapse: collapse;">
                                <tbody>
                                    <tr>
