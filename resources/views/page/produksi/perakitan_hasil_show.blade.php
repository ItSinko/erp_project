        ...
        <div class="col-3">
          <div class="card">
                ...
                <div class="row">
                  ...
                  <hgroup class="col-lg-12"> <!-- hgroup is deprecated, just defiantly using it anyway -->
                  ...
                  <tr style="text-align: left;">
                    <th colspan="12">
                      @if(($sh->HasilPerakitan->count() < $sh->Bppb->jumlah) && ($sh->status == "0"))
                        <a href="{{route('perakitan.hasil.create', ['id' => $id])}}" style="color: white; display:inline-block;"><button type="button" class="btn btn-block btn-success btn-sm" style="width: 200px;"><i class="fas fa-plus"></i> &nbsp; Tambah No Seri Perakitan</i></button></a>
