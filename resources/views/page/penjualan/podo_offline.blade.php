        ...
        <div class='table-responsive'>
          ...
          <table id="tabel" class="table table-hover styled-table table-striped">
            <thead style="text-align: center;">
              <tr>
                <th colspan="12">
                  <a href="/podo_offline/tambah" style="color: white;"><button type="button" class="btn btn-block btn-success btn-sm" style="width: 200px;"><i class="fas fa-plus"></i> &nbsp; Tambah</i></button></a>
                </th>
              </tr>
              <tr>
                <th>No</th>
  ...
  $(function() {
    ...
    $('#tabel > tbody').on('click', '#detail', function() {
      ...
      var y = $('#tabel_detail').DataTable({
        ...
        ajax: '/penjualan_offline/detail/data/' + rows,
        columns: [{
            data: 'DT_RowIndex',
            orderable: false,
            searchable: false
