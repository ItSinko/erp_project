      ...
      columns: [{
        ...
        },
        {
          ...
          render: function(data) {
            ...
            $btn_print = '<a href="/penjualan_offline/cetak_penawaran/' + data + '" target="_break"><button type="button" class="btn btn-block btn-warning karyawan-img-small" style="border-radius:50%;" ><i class="fas fa-print"></i></button></a>';
