                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <select class="form-control @error('market') is-invalid @enderror select2" name="market">
                          ...
                          <option value="Belum bayar">Bli Bli</option>
                          <option value="Lunas">Tokopedia</option>
                          <option value="Batal">Indo Trading</option>
                        </select>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <select class="form-control @error('bayar') is-invalid @enderror select2" name="bayar">
                          <option value="">Pilih Status</option>
                          <option value="Belum bayar">Transfer</option>
                          <option value="Lunas">Cas On Delivery</option>
                          <option value="Batal">Tunai</option>
                        </select>
                        @if($errors->has('status'))
                        <div class="text-danger">
                          {{ $errors->first('status')}}
