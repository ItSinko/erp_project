...
<div class="row">
  <div class="col-lg-12">
    <div class="col-lg-12">
      <form method="post" action="/podo_online/aksi_tambah" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="card">
                ...
                <div class="col-lg-12">
                  <div class="form-horizontal">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <select class="form-control select2 @error('ak1') is-invalid @enderror" name="ak1">
                          <option value="">Customer</option>
                          @foreach ($ekatjual as $e)
                          <option value="{{$e->ak1}}">{{$e->ak1}}</option>
                          @endforeach
                        </select>
                        @if($errors->has('ak1'))
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <select class="form-control @error('ekatjual_id') is-invalid @enderror select2" name="ekatjual_id">
