    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('pengujian.analisa_ps.store', ['id' => $s->id]) }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <h3>BPPB</h3>
                        ...
                        <div class="form-group row">
                            ...
                            <label for="no_bppb" class="col-sm-8 col-form-label">{{$s->MonitoringProses->Bppb->no_bppb}}</label>
                        </div>

                        <div class="form-group row">
                            <label for="nama_produk" class="col-sm-4 col-form-label" style="text-align:right;">Produk</label>
                            <label for="no_bppb" class="col-sm-8 col-form-label">{{$s->MonitoringProses->Bppb->DetailProduk->nama}}</label>
                        </div>
