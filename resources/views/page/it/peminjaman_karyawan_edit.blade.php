                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-horizontal">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <select class="select2 form-control penanggung_jawab_id" name="penanggung_jawab_id" id="penanggung_jawab_id" data-placeholder="Pilih Penanggung Jawab" data-dropdown-css-class="select2-info" style="width: 80%;" readonly="true">
                                                        @foreach($p as $i)
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control @error('nama_penugasan') is-invalid @enderror" name="nama_penugasan" id="nama_penugasan" placeholder="Masukkan Nama Pekerjaan" value="{{old('nama_penugasan', $s->nama_penugasan)}}" style="width:80%;" readonly="true">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control @error('lokasi_penugasan') is-invalid @enderror" name="lokasi_penugasan" id="lokasi_penugasan" placeholder="Masukkan Lokasi Penugasan" value="{{old('lokasi_penugasan', $s->lokasi_penugasan)}}" readonly="true">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan" readonly="true">{{old('keterangan', $s->keterangan)}}</textarea>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-horizontal">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control @error('tanggal_penugasan') is-invalid @enderror" name="tanggal_penugasan" id="tanggal_penugasan" placeholder="Masukkan Tanggal Penugasan" value="{{old('tanggal_penugasan', $s->tanggal_penugasan)}}" style="width:80%;">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control @error('tanggal_estimasi_selesai') is-invalid @enderror" name="tanggal_estimasi_selesai" id="tanggal_estimasi_selesai" placeholder="Masukkan Tanggal Estimasi Selesai" value="{{old('tanggal_estimasi_selesai', $s->tanggal_estimasi_selesai)}}" style="width:80%;">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <table width="100%" class="table table-bordered" id="tableitem" style="text-align:center;">
                                            <thead>
                                                <tr>
                                                    <th colspan="12" style="text-align:left;"><button type="button" class="btn btn-sm btn-success" id="tambahitem"><i class="fas fa-plus"></i>&nbsp;Tambah Baris</button></th>
                                                </tr>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Nama Karyawan</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><select class="select2 form-control karyawan_id" name="karyawan_id[]" id="karyawan_id{{$l}}" data-placeholder="Pilih Karyawan" data-dropdown-css-class="select2-info" style="width: 80%;">
                                                            @foreach($p as $k)
                                                            <option value="{{$k->id}}" @if($k->id == $i->id) selected @endif>{{$k->nama}}</option>
                                                            @endforeach
                                                        </select></td>
                                                    <td><textarea class="form-control" name="keterangan_detail[]" id="keterangan_detail{{$l}}" placeholder="Masukkan Keterangan">{{old('keterangan_detail', $i->pivot->keterangan)}}</textarea></td>
