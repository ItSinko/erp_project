...
class Kesehatan_awal extends Model
{
    ...
    protected $fillable = ['karyawan_id', 'vaksin', 'ket_vaksin', 'tinggi', 'berat', 'lemak', 'kandungan_air', 'otot', 'tulang', 'kalori', 'status_mata', 'tes_covid', 'hasil_covid', 'file_covid', 'file_mcu'];
