...
class CreatePerbaikanProduksiNoSerisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('perbaikan_produksi_no_seris', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('perbaikan_produksi_no_seris');
    }
}
