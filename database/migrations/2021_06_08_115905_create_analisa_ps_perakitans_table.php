...
class CreateAnalisaPsPerakitansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('analisa_ps_perakitans', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('analisa_ps_perakitans');
    }
}
